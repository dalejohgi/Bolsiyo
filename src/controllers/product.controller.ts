...
export class ProductController {
  ...
  async find(
    @param.query.number('companyId') companyId: number,
  ): Promise<Product[]> {
    return this.productRepository.getAllActiveProducts(companyId);
  }
  ...
  async create(
    ...
    return this.productRepository.createNewProduct(productToCreate);
  }
